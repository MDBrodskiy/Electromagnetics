...
% Text Node
\draw (373.5,125.39) node [anchor=south west] [inner sep=0.75pt]    {$( 0,\Gamma _{\parallel } \parallel )$};
% Text Node
\draw (373.5,325.39) node [anchor=south west] [inner sep=0.75pt]    {$( \perp ,\tau _{\parallel } \parallel )$};
